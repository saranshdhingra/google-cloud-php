...
class TargetVpnGatewaysGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.TargetVpnGateways';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/target_vpn_gateways_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/target_vpn_gateways_descriptor_config.php',
            'credentialsConfig' => [
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, TargetVpnGatewayAggregatedList::class, $request);
    }
     ...
     *     $response = $targetVpnGatewaysClient->delete($project, $region, $targetVpnGateway);
     * } finally {
     *     $targetVpnGatewaysClient->close();
     * }
     * ```
    ...
    public function delete($project, $region, $targetVpnGateway, array $optionalArgs = [])
    {
        ...
        $request->setTargetVpnGateway($targetVpnGateway);
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['region'] = $region;
        $requestParamHeaders['target_vpn_gateway'] = $targetVpnGateway;
    ...
    public function get($project, $region, $targetVpnGateway, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', TargetVpnGateway::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $response = $targetVpnGatewaysClient->insert($project, $region, $targetVpnGatewayResource);
     * } finally {
     *     $targetVpnGatewaysClient->close();
     * }
     * ```
     ...
     * @param string           $project                  Project ID for this request.
     * @param string           $region                   Name of the region for this request.
     * @param TargetVpnGateway $targetVpnGatewayResource The body resource for this request
     * @param array            $optionalArgs             {
     *     Optional.
     *
     *     @type string $requestId
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($project, $region, $targetVpnGatewayResource, array $optionalArgs = [])
    {
        $request = new InsertTargetVpnGatewayRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setRegion($region);
        $request->setTargetVpnGatewayResource($targetVpnGatewayResource);
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['region'] = $region;
        if (isset($optionalArgs['requestId'])) {
            $request->setRequestId($optionalArgs['requestId']);
    ...
    public function list($project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, TargetVpnGatewayList::class, $request);
    }
}
