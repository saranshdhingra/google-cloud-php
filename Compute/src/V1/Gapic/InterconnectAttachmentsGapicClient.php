...
use Google\Cloud\Compute\V1\InterconnectAttachmentAggregatedList;
use Google\Cloud\Compute\V1\InterconnectAttachmentList;
...
class InterconnectAttachmentsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.InterconnectAttachments';
    ...
    {
        $request = new AggregatedListInterconnectAttachmentsRequest();
        $requestParamHeaders = [];
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, InterconnectAttachmentAggregatedList::class, $request);
    }
    ...
    public function delete($interconnectAttachment, $project, $region, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders['interconnect_attachment'] = $interconnectAttachment;
        $requestParamHeaders['project'] = $project;
    ...
    public function get($interconnectAttachment, $project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', InterconnectAttachment::class, $optionalArgs, $request)->wait();
    }
    ...
    public function list($project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, InterconnectAttachmentList::class, $request);
    }
