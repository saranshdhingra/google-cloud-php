...
use Google\Cloud\Compute\V1\AcceleratorTypeList;
...
class AcceleratorTypesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.AcceleratorTypes';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/accelerator_types_client_config.json',
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, AcceleratorTypeAggregatedList::class, $request);
    }
    ...
    public function get($acceleratorType, $project, $zone, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders = [];
        $request->setAcceleratorType($acceleratorType);
        $request->setProject($project);
        $request->setZone($zone);
        $requestParamHeaders['accelerator_type'] = $acceleratorType;
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['zone'] = $zone;
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', AcceleratorType::class, $optionalArgs, $request)->wait();
    }
    ...
    public function list($project, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, AcceleratorTypeList::class, $request);
    }
}
