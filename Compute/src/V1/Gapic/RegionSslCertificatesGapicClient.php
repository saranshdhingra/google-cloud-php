...
use Google\Cloud\Compute\V1\DeleteRegionSslCertificateRequest;
 ...
 *     $response = $regionSslCertificatesClient->delete($project, $region, $sslCertificate);
 * } finally {
 *     $regionSslCertificatesClient->close();
 * }
 * ```
 */
class RegionSslCertificatesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.RegionSslCertificates';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/region_ssl_certificates_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/region_ssl_certificates_descriptor_config.php',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/region_ssl_certificates_rest_client_config.php',
                ],
            ],
        ];
    }
     ...
     */
    public function delete($project, $region, $sslCertificate, array $optionalArgs = [])
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($project, $region, $sslCertificate, array $optionalArgs = [])
    {
