...
use Google\Cloud\Compute\V1\PublicDelegatedPrefixAggregatedList;
 ...
 *     $pagedResponse = $publicDelegatedPrefixesClient->aggregatedList($project);
...
class PublicDelegatedPrefixesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.PublicDelegatedPrefixes';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/public_delegated_prefixes_client_config.json',
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, PublicDelegatedPrefixAggregatedList::class, $request);
    }
     ...
     * @throws ApiException if the remote call fails
     */
    public function delete($project, $publicDelegatedPrefix, $region, array $optionalArgs = [])
    {
     ...
     * @throws ApiException if the remote call fails
     */
    public function get($project, $publicDelegatedPrefix, $region, array $optionalArgs = [])
    {
     ...
     *     $region = 'region';
     *     $response = $publicDelegatedPrefixesClient->insert($project, $publicDelegatedPrefixResource, $region);
     * } finally {
     *     $publicDelegatedPrefixesClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($project, $publicDelegatedPrefixResource, $region, array $optionalArgs = [])
    {
     ...
     *     $region = 'region';
     *     // Iterate over pages of elements
     *     $pagedResponse = $publicDelegatedPrefixesClient->list($project, $region);
     *     foreach ($pagedResponse->iteratePages() as $page) {
    ...
    {
        $request = new ListPublicDelegatedPrefixesRequest();
        $requestParamHeaders = [];
        $request->setProject($project);
        $request->setRegion($region);
        $requestParamHeaders['project'] = $project;
     ...
     *     $publicDelegatedPrefixResource = new PublicDelegatedPrefix();
     *     $region = 'region';
     *     $response = $publicDelegatedPrefixesClient->patch($project, $publicDelegatedPrefix, $publicDelegatedPrefixResource, $region);
     * } finally {
     *     $publicDelegatedPrefixesClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function patch($project, $publicDelegatedPrefix, $publicDelegatedPrefixResource, $region, array $optionalArgs = [])
    {
