...
use Google\Cloud\Compute\V1\AggregatedListNodeTypesRequest;
use Google\Cloud\Compute\V1\GetNodeTypeRequest;
...
class NodeTypesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.NodeTypes';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/node_types_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/node_types_descriptor_config.php',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/node_types_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, NodeTypeAggregatedList::class, $request);
    }
     ...
     *     $project = 'project';
     *     $zone = 'zone';
     *     $response = $nodeTypesClient->get($nodeType, $project, $zone);
     * } finally {
     *     $nodeTypesClient->close();
     * }
     * ```
    ...
    public function get($nodeType, $project, $zone, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders['node_type'] = $nodeType;
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['zone'] = $zone;
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', NodeType::class, $optionalArgs, $request)->wait();
    }
    ...
    public function list($project, $zone, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, NodeTypeList::class, $request);
    }
}
