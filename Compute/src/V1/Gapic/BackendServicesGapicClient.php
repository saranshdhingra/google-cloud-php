...
class BackendServicesGapicClient
{
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, BackendServiceAggregatedList::class, $request);
    }
     ...
     *     $backendService = 'backend_service';
     *     $project = 'project';
     *     $response = $backendServicesClient->delete($backendService, $project);
     * } finally {
     *     $backendServicesClient->close();
     * }
     * ```
     ...
     *     $keyName = 'key_name';
     *     $project = 'project';
     *     $response = $backendServicesClient->deleteSignedUrlKey($backendService, $keyName, $project);
     * } finally {
     *     $backendServicesClient->close();
     * }
     * ```
    ...
    public function setSecurityPolicy($backendService, $project, $securityPolicyReferenceResource, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('SetSecurityPolicy', Operation::class, $optionalArgs, $request)->wait();
    }
