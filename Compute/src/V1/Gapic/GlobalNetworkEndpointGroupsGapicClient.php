...
class GlobalNetworkEndpointGroupsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.GlobalNetworkEndpointGroups';
    ...
    public function attachNetworkEndpoints($globalNetworkEndpointGroupsAttachEndpointsRequestResource, $networkEndpointGroup, $project, array $optionalArgs = [])
    {
        ...
        return $this->startCall('AttachNetworkEndpoints', Operation::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $networkEndpointGroup = 'network_endpoint_group';
     *     $project = 'project';
     *     $response = $globalNetworkEndpointGroupsClient->delete($networkEndpointGroup, $project);
     * } finally {
     *     $globalNetworkEndpointGroupsClient->close();
     * }
     * ```
    ...
    public function detachNetworkEndpoints($globalNetworkEndpointGroupsDetachEndpointsRequestResource, $networkEndpointGroup, $project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('DetachNetworkEndpoints', Operation::class, $optionalArgs, $request)->wait();
    }
