...
use Google\Cloud\Compute\V1\DeleteTargetTcpProxyRequest;
use Google\Cloud\Compute\V1\GetTargetTcpProxyRequest;
use Google\Cloud\Compute\V1\InsertTargetTcpProxyRequest;
 ...
 *     $response = $targetTcpProxiesClient->delete($project, $targetTcpProxy);
 * } finally {
...
class TargetTcpProxiesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.TargetTcpProxies';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/target_tcp_proxies_client_config.json',
    ...
    {
        $request = new DeleteTargetTcpProxyRequest();
        $requestParamHeaders = [];
    ...
    public function list($project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, TargetTcpProxyList::class, $request);
    }
