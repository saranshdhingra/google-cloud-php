...
class NetworksGapicClient
{
    ...
    public function addPeering($network, $networksAddPeeringRequestResource, $project, array $optionalArgs = [])
    {
        ...
        return $this->startCall('AddPeering', Operation::class, $optionalArgs, $request)->wait();
    }
    ...
    public function list($project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, NetworkList::class, $request);
    }
    ...
    public function listPeeringRoutes($network, $project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('ListPeeringRoutes', $optionalArgs, ExchangedPeeringRoutesList::class, $request);
    }
    ...
    public function removePeering($network, $networksRemovePeeringRequestResource, $project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('RemovePeering', Operation::class, $optionalArgs, $request)->wait();
    }
    ...
    public function switchToCustomMode($network, $project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('SwitchToCustomMode', Operation::class, $optionalArgs, $request)->wait();
    }
    ...
    public function updatePeering($network, $networksUpdatePeeringRequestResource, $project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('UpdatePeering', Operation::class, $optionalArgs, $request)->wait();
    }
}
