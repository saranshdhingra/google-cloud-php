...
use Google\Cloud\Compute\V1\ListTargetGrpcProxiesRequest;
...
class TargetGrpcProxiesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.TargetGrpcProxies';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/target_grpc_proxies_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/target_grpc_proxies_descriptor_config.php',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/target_grpc_proxies_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    public function list($project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, TargetGrpcProxyList::class, $request);
    }
