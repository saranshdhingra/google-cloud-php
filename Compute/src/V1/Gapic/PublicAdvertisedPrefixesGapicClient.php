 ...
 *     $response = $publicAdvertisedPrefixesClient->delete($project, $publicAdvertisedPrefix);
 * } finally {
...
class PublicAdvertisedPrefixesGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/public_advertised_prefixes_client_config.json',
    ...
    public function list($project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, PublicAdvertisedPrefixList::class, $request);
    }
     ...
     *     $publicAdvertisedPrefix = 'public_advertised_prefix';
     *     $publicAdvertisedPrefixResource = new PublicAdvertisedPrefix();
     *     $response = $publicAdvertisedPrefixesClient->patch($project, $publicAdvertisedPrefix, $publicAdvertisedPrefixResource);
     * } finally {
     *     $publicAdvertisedPrefixesClient->close();
     * }
     * ```
