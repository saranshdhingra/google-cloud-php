...
class GlobalOperationsGapicClient
{
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, OperationAggregatedList::class, $request);
    }
    ...
    public function delete($operation, $project, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Delete', DeleteGlobalOperationResponse::class, $optionalArgs, $request)->wait();
    }
