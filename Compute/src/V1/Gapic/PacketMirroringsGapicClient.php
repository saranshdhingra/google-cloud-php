...
use Google\Cloud\Compute\V1\AggregatedListPacketMirroringsRequest;
use Google\Cloud\Compute\V1\DeletePacketMirroringRequest;
use Google\Cloud\Compute\V1\GetPacketMirroringRequest;
...
class PacketMirroringsGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.PacketMirrorings';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/packet_mirrorings_client_config.json',
    ...
    public function aggregatedList($project, array $optionalArgs = [])
    {
        ...
        return $this->getPagedListResponse('AggregatedList', $optionalArgs, PacketMirroringAggregatedList::class, $request);
    }
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $response = $packetMirroringsClient->delete($packetMirroring, $project, $region);
     * } finally {
     *     $packetMirroringsClient->close();
     * }
     * ```
    ...
    public function delete($packetMirroring, $project, $region, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders['packet_mirroring'] = $packetMirroring;
        $requestParamHeaders['project'] = $project;
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $response = $packetMirroringsClient->get($packetMirroring, $project, $region);
     * } finally {
     *     $packetMirroringsClient->close();
     * }
     * ```
    ...
    public function get($packetMirroring, $project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', PacketMirroring::class, $optionalArgs, $request)->wait();
    }
    ...
    public function list($project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, PacketMirroringList::class, $request);
    }
