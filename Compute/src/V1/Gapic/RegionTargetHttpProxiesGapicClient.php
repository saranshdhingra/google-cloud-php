...
use Google\Cloud\Compute\V1\DeleteRegionTargetHttpProxyRequest;
 ...
 *     $response = $regionTargetHttpProxiesClient->delete($project, $region, $targetHttpProxy);
 * } finally {
...
class RegionTargetHttpProxiesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.RegionTargetHttpProxies';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/region_target_http_proxies_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/region_target_http_proxies_descriptor_config.php',
            'credentialsConfig' => [
    ...
    public function list($project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, TargetHttpProxyList::class, $request);
    }
