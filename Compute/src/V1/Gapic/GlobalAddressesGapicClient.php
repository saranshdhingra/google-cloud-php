...
class GlobalAddressesGapicClient
{
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/global_addresses_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/global_addresses_descriptor_config.php',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/global_addresses_rest_client_config.php',
                ],
            ],
        ];
    }
