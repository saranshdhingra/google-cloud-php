...
class RegionHealthCheckServicesGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.compute.v1.RegionHealthCheckServices';
    ...
    private static function getClientDefaults()
    {
        return [
            ...
            'clientConfig' => __DIR__ . '/../resources/region_health_check_services_client_config.json',
            'descriptorsConfigPath' => __DIR__ . '/../resources/region_health_check_services_descriptor_config.php',
            'credentialsConfig' => [
                'defaultScopes' => self::$serviceScopes,
            ],
            'transportConfig' => [
                'rest' => [
                    'restClientConfigPath' => __DIR__ . '/../resources/region_health_check_services_rest_client_config.php',
                ],
            ],
        ];
    }
    ...
    public function delete($healthCheckService, $project, $region, array $optionalArgs = [])
    {
        ...
        $requestParamHeaders = [];
        $request->setHealthCheckService($healthCheckService);
        $request->setProject($project);
        $request->setRegion($region);
        $requestParamHeaders['health_check_service'] = $healthCheckService;
    ...
    public function get($healthCheckService, $project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->startCall('Get', HealthCheckService::class, $optionalArgs, $request)->wait();
    }
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $response = $regionHealthCheckServicesClient->insert($healthCheckServiceResource, $project, $region);
     * } finally {
     *     $regionHealthCheckServicesClient->close();
     * }
     * ```
     *
     * @param HealthCheckService $healthCheckServiceResource The body resource for this request
     * @param string             $project                    Project ID for this request.
     * @param string             $region                     Name of the region scoping this request.
     * @param array              $optionalArgs               {
     *     Optional.
     ...
     * @throws ApiException if the remote call fails
     */
    public function insert($healthCheckServiceResource, $project, $region, array $optionalArgs = [])
    {
        $request = new InsertRegionHealthCheckServiceRequest();
        $requestParamHeaders = [];
        $request->setHealthCheckServiceResource($healthCheckServiceResource);
        $request->setProject($project);
        $request->setRegion($region);
        $requestParamHeaders['project'] = $project;
        $requestParamHeaders['region'] = $region;
    ...
    public function list($project, $region, array $optionalArgs = [])
    {
        ...
        $requestParams = new RequestParamsHeaderDescriptor($requestParamHeaders);
        $optionalArgs['headers'] = isset($optionalArgs['headers']) ? array_merge($requestParams->getHeader(), $optionalArgs['headers']) : $requestParams->getHeader();
        return $this->getPagedListResponse('List', $optionalArgs, HealthCheckServicesList::class, $request);
    }
     ...
     *     $project = 'project';
     *     $region = 'region';
     *     $response = $regionHealthCheckServicesClient->patch($healthCheckService, $healthCheckServiceResource, $project, $region);
     * } finally {
     *     $regionHealthCheckServicesClient->close();
     * }
     * ```
     ...
     * @throws ApiException if the remote call fails
     */
    public function patch($healthCheckService, $healthCheckServiceResource, $project, $region, array $optionalArgs = [])
    {
